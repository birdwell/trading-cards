import { getSport } from "../src/get-sport";
...
describe("getSport", () => {
  ...
  test("should detect basketball from Beckett basketball URLs", () => {
    const url = "https://www.beckett.com/news/2024-25-panini-nba-hoops-basketball-cards/";
    expect(getSport(url)).toBe(Sport.Basketball);
  });

  test("should handle case insensitive matching", () => {
    expect(getSport("https://beckett.com/FOOTBALL-cards")).toBe(Sport.Football);
    expect(getSport("https://beckett.com/BASKETBALL-cards")).toBe(Sport.Basketball);
  });
